...
def animate(start, goal, path, visited_list):
    ...
    rectangles = [pygame.Rect(100, 0, 75, 400), pygame.Rect(275, 100, 75, 400), pygame.Rect(900, 50, 200, 75),
                  pygame.Rect(1020, 125, 80, 250), pygame.Rect(900, 375, 200, 75)]
    
    for rect in rectangles:
        pygame.draw.rect(static_surface, dark_pastel_background, rect)
    pygame.draw.polygon(static_surface, dark_pastel_background, [(650, 100), (520, 175), (520, 325), (650, 400), (780, 325), (780, 175)])

    clock = pygame.time.Clock()
    visited_index = 0  
    nodes_per_frame = 10000
    path_index = 0
    ...
    while running:
        ...
        pygame.draw.circle(canvas, red, (start[0], 500 - start[1]), 5)
        pygame.draw.circle(canvas, blue, (goal[0], 500 - goal[1]), 5)
        pygame.display.flip()
        clock.tick(60)
    pygame.quit()
    sys.exit()
